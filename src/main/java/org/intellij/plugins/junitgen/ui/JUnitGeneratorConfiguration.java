...
public class JUnitGeneratorConfiguration {
    ...
    private JComboBox<String> methodGenerationComboBox;
    private JTextField outputTextBox;
    private JComboBox<Boolean> settingsTypeComboBox;
    private JLabel settingsTypeLabel;
    private JButton copyGobalSettingsToButton;
    private JComboBox<String> selectedTemplateComboBox;
    private final List<Editor> velocityEditor = new ArrayList<>();
    ...
    public JUnitGeneratorConfiguration(JUnitGeneratorSettings settings, Project project) {
        ...
        this.settingsTypeComboBox.addItemListener(e -> updateSettingsVisibility());
        copyGobalSettingsToButton.addActionListener(e -> {
    ...
    public void setVmTemplate(Map<String, String> templates) {
        ...
        if (this.velocityEditor.isEmpty()) {
            //create the editors
