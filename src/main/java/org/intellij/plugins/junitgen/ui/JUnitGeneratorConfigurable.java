...
public abstract class JUnitGeneratorConfigurable implements SearchableConfigurable {
    ...
    public boolean isModified() {
        ...
        boolean delta = !JUnitGeneratorUtil.isEqual(this.settings.getVmTemplates(), this.configuration.getVmTemplates()) ||
                !Objects.equals(this.settings.getListOverloadedMethodsBy(), this.configuration.getListOverloadedMethodsBy()) ||
                !Objects.equals(this.settings.getOutputFilePattern(), this.configuration.getOutput()) ||
                ...
                !Objects.equals(this.settings.getSelectedTemplateKey(), this.configuration.getSelectedTemplateName());
