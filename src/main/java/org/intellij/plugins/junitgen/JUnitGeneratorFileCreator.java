...
public class JUnitGeneratorFileCreator implements Runnable {
    ...
    private org.intellij.plugins.junitgen.JUnitGeneratorContext genCtx;
     ...
     */
    public JUnitGeneratorFileCreator(String outputFile, StringWriter writer, org.intellij.plugins.junitgen.JUnitGeneratorContext genCtx) {
